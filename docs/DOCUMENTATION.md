...
- `BUS` - Compagnies de bus
- `route` - Trajets entre villes
- `VOYAGE` - Voyages programmés
- `Reservation` - Réservations
- `payments` - Paiements
- `Siege` - Sièges réservés
- `Ticket` - Ticket de reservation
- `Ville` - la destination de le voyage
- `tarif` - la assosiation pertuse entre ville et route
- `passer_par` - la assosiation pertuse entre ville et route
- `avie` - a assosiation pertuse entre Utilisateur et Voyage
